...
BULLET_HIT_SOUND = pygame.mixer.Sound(os.path.join('Assets', 'Hit Sound.mp3'))
BULLET_FIRE_SOUND = pygame.mixer.Sound(
    os.path.join('Assets', 'Fire Sound.mp3'))
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    ...
    WIN.blit(YELLOW_SPACESHIP, (yellow.x, yellow.y))  # order matters
